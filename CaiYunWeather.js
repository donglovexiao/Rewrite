...
if (typeof $response == "undefined") {
  ...
  chxm1024.headers['device-token'] = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..U_LCYNGl3cbBCpjrnjmxYBAuNFSvNCe3dKIrV1MGpzo';
} else {
  switch (true) {
    case adUrl.test(url):
      chxm1023.status = "ok";
