...
if (isGetCookie) {
  !(async () => {
    ...
    if ($.setdata(JSON.stringify(session), $.signKeyKFX)) {
      $.subt = `获取会话: 成功!`
    } else {
      $.subt = `获取会话: 失败!`
    }
...
'User-Agent':'Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.40(0x18002824) NetType/4G Language/zh_CN',
